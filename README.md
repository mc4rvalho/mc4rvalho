# Olá, meu nome é Matheus da Silva Carvalho 👋

### Sou um aprendiz e entusiasta de código focado em criar experiências web incríveis.

🔭 **O que estou fazendo?**

Estou consolidando minha base em **JavaScript e TypeScript** (🟢) enquanto estudo em andamento os frameworks **ReactJS e Angular** (🟡).

🎯 **Objetivo**

Meu foco é me tornar um desenvolvedor **Full Stack** (ou Front-end Specialist), capaz de transitar entre diferentes frameworks com facilidade, utilizando a tipagem forte do TypeScript para criar códigos escaláveis.
...
<p align="left">
  ...
  <a href="https://www.linkedin.com/in/matheus-carvalho-b22254201/" target="_blank">
